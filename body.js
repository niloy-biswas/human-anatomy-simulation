...
const SYSTEMS = [
  ...
  { key: 'joints',   labelBn: 'সন্ধি',         labelEn: 'Joints',           color: '#B8C5D6', visible: true  },
  { key: 'muscular', labelBn: 'পেশীতন্ত্র',   labelEn: 'Muscular System',  color: '#C0392B', visible: true  },
  { key: 'fasciae',  labelBn: 'ফ্যাসিয়া',    labelEn: 'Fasciae',          color: '#E8C9A0', visible: true  },
  { key: 'arterial', labelBn: 'ধমনীতন্ত্র',  labelEn: 'Arterial System',  color: '#E74C3C', visible: true  },
  { key: 'venous',   labelBn: 'শিরাতন্ত্র',  labelEn: 'Venous System',    color: '#2980B9', visible: true  },
  { key: 'lymphoid', labelBn: 'লসিকাতন্ত্র', labelEn: 'Lymphoid System',  color: '#8E44AD', visible: true  },
  { key: 'nervous',  labelBn: 'স্নায়ুতন্ত্র', labelEn: 'Nervous System',  color: '#F1C40F', visible: true  },
  { key: 'visceral', labelBn: 'অঙ্গতন্ত্র',  labelEn: 'Visceral Systems', color: '#E67E22', visible: true  },
];
...
const BN_LABELS = {
  // Skeletal
  'Femur': { bn: 'ঊরুর হাড়', desc: 'মানবদেহের সবচেয়ে বড় ও শক্তিশালী হাড়। এটি উরুতে অবস্থিত এবং হাঁটু ও নিতম্বের সাথে সংযুক্ত।' },
  'Tibia': { bn: 'পায়ের নলার হাড়', desc: 'পায়ের নিচের অংশের দুটি হাড়ের মধ্যে বড়টি। এটি ভার বহন করে এবং হাঁটু থেকে গোড়ালি পর্যন্ত বিস্তৃত।' },
  'Fibula': { bn: 'পায়ের সরু হাড়', desc: 'পায়ের নলার পাশের সরু হাড়। এটি সরাসরি ওজন বহন করে না কিন্তু গোড়ালির স্থিতিশীলতায় সাহায্য করে।' },
  'Humerus': { bn: 'বাহুর হাড়', desc: 'ওপরের বাহুর প্রধান হাড়। কাঁধ থেকে কনুই পর্যন্ত বিস্তৃত।' },
  'Radius': { bn: 'বাহুর বাইরের হাড়', desc: 'কনুই থেকে কব্জি পর্যন্ত বিস্তৃত দুটি হাড়ের মধ্যে একটি।' },
  'Ulna': { bn: 'বাহুর ভেতরের হাড়', desc: 'কনুই থেকে কব্জি পর্যন্ত বিস্তৃত দুটি হাড়ের মধ্যে অন্যটি।' },
  'Skull': { bn: 'খুলি', desc: 'মাথার হাড়সমূহ যা মস্তিষ্ককে সুরক্ষিত রাখে।' },
  'Mandible': { bn: 'চোয়ালের হাড়', desc: 'নিচের চোয়ালের হাড়। এটি মুখের একমাত্র নড়াচড়াযোগ্য হাড়।' },
  'Clavicle': { bn: 'কলারবোন', desc: 'বুকের উপর থেকে কাঁধ পর্যন্ত বিস্তৃত S-আকৃতির হাড়।' },
  'Scapula': { bn: 'কাঁধের হাড়', desc: 'পিঠের উপরের দিকে অবস্থিত ত্রিভুজাকার হাড়।' },
  'Sternum': { bn: 'বুকের সামনের হাড়', desc: 'বুকের মাঝখানে অবস্থিত হাড় যার সাথে পাঁজর সংযুক্ত।' },
  'Patella': { bn: 'হাঁটুর হাড়', desc: 'হাঁটুর সামনে অবস্থিত ছোট গোলাকার হাড়।' },
  'Pelvis': { bn: 'পেলভিস', desc: 'নিতম্বের হাড়ের কাঠামো যা মেরুদণ্ড ও পায়ের হাড়ের সাথে সংযুক্ত।' },
  'Sacrum': { bn: 'মেরুদণ্ডের নিচের হাড়', desc: 'মেরুদণ্ডের নিচের দিকে অবস্থিত ত্রিভুজাকার হাড়।' },
  'Vertebral column': { bn: 'মেরুদণ্ড', desc: 'পিঠের মাঝ বরাবর ৩৩টি কশেরুকা নিয়ে গঠিত কাঠামো।' },
  // Muscular
...
const dirLight2 = new THREE.DirectionalLight(0x8090ff, 0.4);
dirLight2.position.set(-3, 2, -2);
scene.add(dirLight2);

const hemiLight = new THREE.HemisphereLight(0x334466, 0x221122, 0.4);
scene.add(hemiLight);
...
/* ─── Highlight Colors ────────────────────────────────────────── */
const HOVER_EMISSIVE    = new THREE.Color(0x1CAB55).multiplyScalar(0.4);
const SELECTED_EMISSIVE = new THREE.Color(0x1CAB55).multiplyScalar(0.7);
...
function onModelLoaded(gltf) {
  ...
  // Apply system colors to anatomy meshes whose material has no baseColorFactor
  // (Three.js defaults them to pure white). Meshes with real colors (organs, etc.) keep theirs.
  SYSTEMS.forEach(s => {
    const sysColor = new THREE.Color(s.color);
    (systemMeshes[s.key] ?? []).forEach(mesh => {
      const mats = Array.isArray(mesh.material) ? mesh.material : [mesh.material];
      mats.forEach(m => {
        if (!m?.color) return;
        // Pure white = no baseColorFactor in source GLTF → override with system color
        if (m.color.r >= 0.99 && m.color.g >= 0.99 && m.color.b >= 0.99) m.color.copy(sysColor);
      });
    });
  });

  root.traverse((obj) => {
    if (obj.isMesh) obj.userData.origEmissive = obj.material?.emissive?.clone() ?? ZERO_COLOR.clone();
  });
...
mobileSysBtn.addEventListener('click', () => {
...
canvas.addEventListener('pointermove', (e) => {
  ...
  if (hoveredMesh && hoveredMesh !== selectedMesh) {
    setEmissive(hoveredMesh, hoveredMesh.userData.origEmissive);
    hoveredMesh = null;
  }
...
canvas.addEventListener('click', (e) => {
  ...
  if (hits.length > 0) {
    ...
    if (selectedMesh && selectedMesh !== mesh) {
      setEmissive(selectedMesh, selectedMesh.userData.origEmissive);
    }
    selectedMesh = mesh;
    setEmissive(mesh, SELECTED_EMISSIVE);
...
function setEmissive(mesh, color) {
  ...
  const mats = Array.isArray(mesh.material) ? mesh.material : [mesh.material];
  mats.forEach(m => { if (m.emissive) m.emissive.copy(color); });
}
...
function cleanName(name) {
  /* Strip Z-Anatomy suffixes: .t .e .g .o .r .l .e1 etc. */
  return name.replace(/\.(t|e\d*|g|o\d*|r|l|st|j)$/, '').trim();
}
